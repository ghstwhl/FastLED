...
LIB8STATIC u16 beat88(accum88 beats_per_minute_88, u32 timebase = 0) {
...
/// @param timebase the time offset of the wave from the millis() timer
LIB8STATIC u16 beat16(accum88 beats_per_minute, u32 timebase = 0) {
...
/// @param beats_per_minute the frequency of the wave, in decimal
/// @param timebase the time offset of the wave from the millis() timer
LIB8STATIC u8 beat8(accum88 beats_per_minute, u32 timebase = 0) {
